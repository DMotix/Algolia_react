jQuery(document).ready(function ($) {
    ...
    if (algoliaSettings.type_of_search.indexOf("instant") !== -1)
    {
        ...
        function searchCallback(content)
        {
            ...
            var pages = [];
            var facets_html = '';
            var oldClass = $('#center_column').attr('class');
            var newClass = 'center_column col-xs-12 col-xs-6 col-sm-9 col-md-9';
            ...
            if (content.hits.length > 0)
            {
                ...
                if (!algoliaSettings.use_left_column) {
                    if ($('#left_column').length == 0) {
                        $('#center_column').attr('class', newClass);
            ...
            */
            ...
            if (typeof($('#textbannersmodule')) !== 'undefined') {
                if (content.query == "") {
                    $('#textbannersmodule').show();
                    
                } else {
                    $('#textbannersmodule').hide();
                }
            }
